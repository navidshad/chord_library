 <template>
  <div>
    ...
    <section :key="compKey">
      ...
      >
        <div class="flex items-end justify-between">
          <v-btn color="primary" :loading="melody._pending" @click="onRemoveMelody(i)">{{
        ...
        >
          ...
          />
          <v-btn v-if="melody._file" icon depressed :loading="melody._pending">
    ...
    <section>
      <v-btn rounded @click="addNewMelody">{{
